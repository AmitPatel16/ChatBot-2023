...
function App() {
  ...
  const handleInput = () => {
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Amit patel";
        inputRef.value = ""; // clear the input
      }, 2000);
    }

    let owner2 = [
      "Who's Amit|who's amit|Who is amit|who is Amit",
    ];
    ...
    if (words10.test(document.querySelector("#input").value)) {
      ...
      setTimeout(() => {
        getBotMessage.innerText =
          "Amit is a programmer based on ReactJS and python he is the owner of a youtube channel called OpenTech Tv";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
